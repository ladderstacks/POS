...
class SettingTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Warehouse::create([
            ...
            'country' => 'india',
            'city' => 'mumbai',
            'email' => 'warehouse1@nginxbyte.com',
            'zip_code' => '12345',
        ]);
        ...
        if (! keyExist('email')) {
            Setting::create(['key' => 'email', 'value' => 'support@nginxbyte.com']);
        }

        if (! keyExist('company_name')) {
            Setting::create(['key' => 'company_name', 'value' => 'nginxbyte']);
        }
        ...
        if (! keyExist('developed')) {
            Setting::create(['key' => 'developed', 'value' => 'nginxbyte']);
        }
