...
export const bankAccountsActionType = {
    ...
    FETCH_BANK_ACCOUNT: "FETCH_ALL_BANK_ACCOUNT",
    FETCH_BANK_ACCOUNT_FORM_DATA_CURRENCY: "FETCH_BANK_ACCOUNT_FORM_DATA_CURRENCY",
    FETCH_BANK_ACCOUNT_FORM_DATA_COUNTRY: "FETCH_BANK_ACCOUNT_FORM_DATA_COUNTRY",
};
export const employeeActionType = {
    ...
    FETCH_EMPLOYEE: "FETCH_ALL_EMPLOYEE",
    FETCH_EMPLOYEE_FORM_DATA: "FETCH_EMPLOYEE_FORM_DATA",
};

export const departmentsActionType = {
...
export const attendancesActionType = {
    FETCH_ATTENDANCES: "FETCH_ATTENDANCES",
    ...
    FETCH_ALL_ATTENDANCES: "FETCH_ALL_ATTENDANCES",
    FETCH_ATTENDANCE_FORM_DATA: "FETCH_ATTENDANCE_FORM_DATA",
};

export const payrollsActionType = {
    FETCH_PAYROLLS: "FETCH_PAYROLLS",
    ADD_PAYROLLS: "ADD_PAYROLLS",
    EDIT_PAYROLLS: "EDIT_PAYROLLS",
    DELETE_PAYROLLS: "DELETE_PAYROLLS",
    FETCH_PAYROLL: "FETCH_ALL_PAYROLL",
    FETCH_PAYROLL_FORM_DATA_EMPLOYEE: "FETCH_PAYROLL_FORM_DATA_EMPLOYEE",
    FETCH_PAYROLL_FORM_DATA_BANK_ACCOUNT: "FETCH_PAYROLL_FORM_DATA_BANK_ACCOUNT",
};
